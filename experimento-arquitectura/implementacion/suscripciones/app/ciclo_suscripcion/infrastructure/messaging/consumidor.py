...
from app.ciclo_suscripcion.application.commands.procesar_trabajo_finalizado import (
    ProcesarTrabajoFinalizadoCommand,
    ejecutar_procesar_trabajo_finalizado,
)
    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                id_evento = props.get("id_evento") or payload.get(
                    "id_evento", str(msg.message_id())
                )
                correlation_id = props.get("correlation_id") or payload.get(
                    "correlation_id", ""
                )
