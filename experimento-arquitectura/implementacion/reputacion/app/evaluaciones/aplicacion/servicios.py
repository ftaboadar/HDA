...
class ServicioReputacion:
    ...
    def procesar_novedad_resuelta(self, partner_id: str, calificacion: float):
        ...
        evento = ReputacionPublicada(
            partner_id=partner_id, nuevo_promedio=nueva_reputacion.promedio_actual
        )
        self.mensajeria.publicar(
            "persistent://hda/evaluaciones/reputacion.publicada",
            evento,
            schema=JsonSchema(ReputacionPublicada),
        )
