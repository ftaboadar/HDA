class ReputacionPartner:
    def __init__(self, partner_id: str, promedio_actual: float, total_evaluaciones: int):
    ...
    def actualizar_promedio(self, nueva_calificacion: float) -> 'ReputacionPartner':
        ...
        nuevo_promedio = ((self.promedio_actual * self.total_evaluaciones) + nueva_calificacion) / nuevo_total
