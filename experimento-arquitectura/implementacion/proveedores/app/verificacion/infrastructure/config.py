...
from app.verificacion.application.ports.verificacion_externa import IVerificacionExternaPort
from app.verificacion.domain.value_objects import TipoVerificador
from app.verificacion.infrastructure.external.adaptador_certificadora import (
    AdaptadorCertificadora,
)
from app.verificacion.infrastructure.external.adaptador_policia import AdaptadorPolicia
from app.verificacion.infrastructure.external.adaptador_rues import AdaptadorRUES
