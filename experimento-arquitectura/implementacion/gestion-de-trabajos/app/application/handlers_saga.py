...
class SagaHandlers:
    ...
    async def _procesar_y_publicar(
        self, saga, trabajo, comandos, evento_nombre, payload
    ):
    ...
    async def handle_franja_reservada(self, payload: dict):
        ...
        await self._procesar_y_publicar(
            saga, None, comandos, "FranjaReservada", payload
        )
    ...
    async def handle_franja_rechazada(self, payload: dict):
        ...
        await self._procesar_y_publicar(
            saga, None, comandos, "FranjaRechazada", payload
        )
    ...
    async def handle_pago_retenido(self, payload: dict):
        ...
        await self._procesar_y_publicar(
            saga, trabajo, comandos, "PagoRetenido", payload
        )
    ...
    async def handle_pago_retencion_fallida(self, payload: dict):
        ...
        await self._procesar_y_publicar(
            saga, trabajo, comandos, "PagoRetencionFallida", payload
        )
