import uuid
from marketplace.aplicacion.comandos.diagnosticar_solicitud import DiagnosticarSolicitud, DiagnosticarSolicitudHandler
from marketplace.aplicacion.comandos.seleccionar_proveedor import SeleccionarProveedor, SeleccionarProveedorHandler
...
class MockDespachador:
    def publicar_diagnostico(self, evento): pass
    def publicar_seleccion(self, evento): pass
...
def test_diagnosticar_solicitud():
    ...
    comando = DiagnosticarSolicitud(solicitud_id=solicitud_id, descripcion="Falla", severidad="Alta")
