...
resource "google_secret_manager_secret_version" "db_url" {
  ...
  secret_data = "postgresql+psycopg2://hda:${random_password.db_password.result}@/marketplace?host=/cloudsql/${google_sql_database_instance.marketplace.connection_name}"
}
