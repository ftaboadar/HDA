...
| 3.3 | Documento final | *"Escribe el documento final de la Entrega 5 en contexto/19-documento-entrega-5.md: resultados cuantitativos y cualitativos y conclusiones por escenario (del veredicto), justificación de decisiones (§3.4, incluyendo optimización de costos en topología de datos, mantenimiento de instancia dedicada, justificación de BD relacional Postgres frente a Mongo/Serverless/Redis), modelo de datos por servicio, tipos de mensajes (§7.2), esquemas y versionamiento (§7.3, §14), saga y Saga Log (§7.1, §11.2), DDD por servicio (capas, puertos y adaptadores, agregados), justificación de GCP, enlaces a AsyncAPI (HTML), Swagger de cada servicio, link del BFF y la colección Postman, y el refinamiento (17)."* | Revisado por los tres |
